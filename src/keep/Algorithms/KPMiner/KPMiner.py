import pke
import os
from keep.utility import ComputeDF, getlanguage, CreateKeywordsFolder, LoadFiles, Convert2TrecEval
...
class KPMiner(object):
    def __init__(self, numOfKeywords, pathData, dataset_name, normalization):
        ...
        self.__keywordsPath = self.__pathData + '/Keywords/KPMiner/' + self.__dataset_name
